...
<form method ="post"   action="">  
  <h1>Flight Number (Use to Search flight's details)</h1>
...
<input type="number" name="noOfBookings" class="form-control" placeholder="Enter number of bookings" value="<?php echo($noOfBookings);?>" required>
    ...
    <a href="flights_update.php"class="btn btn-info btn-block btn-lg">Update | Delete | Find</a>
